...
type Auth struct {
	...
	Redis         *Auth_Redis            `protobuf:"bytes,2,opt,name=redis,proto3" json:"redis,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Auth) GetRedis() *Auth_Redis {
	if x != nil {
		return x.Redis
	}
	return nil
...
type Auth_Jwt struct {
	...
	Issuer        string                 `protobuf:"bytes,3,opt,name=issuer,proto3" json:"issuer,omitempty"`  // 签发者
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Auth_Redis) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Auth_Redis) ProtoMessage() {}

func (x *Auth_Redis) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Auth_Redis.ProtoReflect.Descriptor instead.
func (*Auth_Redis) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{5, 1}
}

func (x *Auth_Redis) GetNetwork() string {
	if x != nil {
		return x.Network
	}
	return ""
...
func (x *Auth_Redis) GetAddr() string {
	if x != nil {
		return x.Addr
	}
	return ""
...
func (x *Auth_Redis) GetPassword() string {
	if x != nil {
		return x.Password
	}
	return ""
...
func (x *Auth_Redis) GetDialTimeout() *durationpb.Duration {
	if x != nil {
		return x.DialTimeout
	}
	return nil
...
func (x *Auth_Redis) GetReadTimeout() *durationpb.Duration {
	if x != nil {
		return x.ReadTimeout
	}
	return nil
...
func (x *Auth_Redis) GetWriteTimeout() *durationpb.Duration {
	if x != nil {
		return x.WriteTimeout
	}
	return nil
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\x04data\x18\x02 \x01(\v2\x10.kratos.api.DataR\x04data\"\xe6\x02\n" +
	"\x06Server\x12+\n" +
	...
	"\atimeout\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\atimeout\x1ai\n" +
	"\x04Http\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	...
	"\x06scheme\x18\x02 \x01(\tR\x06scheme\"\xcb\x03\n" +
	"\x04Auth\x12&\n" +
	"\x03jwt\x18\x01 \x01(\v2\x14.kratos.api.Auth.JwtR\x03jwt\x12,\n" +
	"\x05redis\x18\x02 \x01(\v2\x16.kratos.api.Auth.RedisR\x05redis\x1aM\n" +
	"\x03Jwt\x12\x16\n" +
	"\x06secret\x18\x01 \x01(\tR\x06secret\x12\x16\n" +
	"\x06expire\x18\x02 \x01(\x03R\x06expire\x12\x16\n" +
	"\x06issuer\x18\x03 \x01(\tR\x06issuer\x1a\x9d\x02\n" +
	"\x05Redis\x12\x18\n" +
	"\anetwork\x18\x01 \x01(\tR\anetwork\x12\x12\n" +
	"\x04addr\x18\x02 \x01(\tR\x04addr\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12\x0e\n" +
	...
	"\fdial_timeout\x18\x05 \x01(\v2\x19.google.protobuf.DurationR\vdialTimeout\x12<\n" +
	"\fread_timeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\vreadTimeout\x12>\n" +
	"\rwrite_timeout\x18\a \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeoutBFZDgithub.com/johnsonoklii/agentgo/apps/agentService/internal/conf;confb\x06proto3"
...
var file_conf_conf_proto_goTypes = []any{
	...
	(*Auth_Redis)(nil),          // 12: kratos.api.Auth.Redis
	(*durationpb.Duration)(nil), // 13: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: kratos.api.Bootstrap.server:type_name -> kratos.api.Server
	2,  // 1: kratos.api.Bootstrap.data:type_name -> kratos.api.Data
	6,  // 2: kratos.api.Server.grpc:type_name -> kratos.api.Server.GRPC
	...
	10, // 6: kratos.api.Registry.consul:type_name -> kratos.api.Registry.Consul
	11, // 7: kratos.api.Auth.jwt:type_name -> kratos.api.Auth.Jwt
	12, // 8: kratos.api.Auth.redis:type_name -> kratos.api.Auth.Redis
	...
	13, // 11: kratos.api.Data.Redis.dial_timeout:type_name -> google.protobuf.Duration
	...
	13, // 14: kratos.api.Auth.Redis.dial_timeout:type_name -> google.protobuf.Duration
	13, // 15: kratos.api.Auth.Redis.read_timeout:type_name -> google.protobuf.Duration
	13, // 16: kratos.api.Auth.Redis.write_timeout:type_name -> google.protobuf.Duration
